...
type Section = "home" | "wiki" | "search" | "gallery" | "publish" | "forum" | "tools" | "collections" | "calendar" | "admin" | "profile" | "login" | "post-detail" | "work-detail" | "tool-detail";
type WikiPage = {
  id: number;
  title: string;
  slug: string;
...
export default function Home() {
  ...
  const searchResults = useMemo(() => {
    ...
    const postResults = !tag && inScope("forum") ? posts
      ...
      .map((item) => ({ type: "讨论", scope: "forum" as SearchScope, title: item.title, desc: item.content, id: item.id, tags: [item.board], imageUrl: undefined })) : [];
